...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    primary: "text-white shadow-lg shadow-indigo-900/20 border border-indigo-500/50 hover:border-indigo-400 focus:ring-indigo-500 bg-indigo-600",
  ...
  return (
    ...
    >
      ...
      {variant === 'primary' && (
        <div className="absolute inset-0 bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 bg-[length:200%_auto] animate-[gradient-shift_3s_ease_infinite]" />
      )}
